        ...
        for (int i = 0; i < toDraw.size(); i++) {
            switch (toDraw.get(i)) {
                case 0:
                    ...
                    break;
                case 1:
                    g.drawImage(new ImageIcon("src/Images/back.png").getImage(), 400, y - num1, 100, 150, null);
                    num1++;
                    break;
                case 2:
                    g.drawImage(new ImageIcon("src/Images/back.png").getImage(), 200, 350 - num2, 100, 150, null);
                    num2++;
                    break;
                case 3:
                    g.drawImage(new ImageIcon("src/Images/back.png").getImage(), 0, y - num3, 100, 150, null);
                    num3++;
                    break;
            }
        }
